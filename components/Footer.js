            ...
            <div className="max-w-2xl mx-auto text-white py-10">
                <div className="text-center">
                    ...
                    <div className="flex justify-center my-10">
                        <a href="https://x.com/daodeepverse" target="_blank" rel="noopener noreferrer" className="flex items-center border rounded-lg px-4 py-2 w-44 mx-2">
                            <Image src="/twitterx.svg" alt="Twitter Icon" width={500} height={500} className="w-7 md:w-8"/>
                        ...
                        <a href="https://www.linkedin.com/daodeepverse" target="_blank" rel="noopener noreferrer" className="flex items-center border rounded-lg px-4 py-2 w-44 mx-2">
                            <Image src="/linkedin.svg" alt="LinkedIn Icon" width={500} height={500} className="w-7 md:w-8"/>
                            <div className="text-left ml-3">
                                <p className='text-xs text-gray-200'>Follow us on</p>
